...
file_permissions=(
  ...
  ["/usr/local/bin/fenrir-mkinitcpio-setup"]="0:0:755"
  ["/usr/local/bin/fenrir-kernel-switcher"]="0:0:755"
  ["/usr/local/bin/fenrir-driver-manager"]="0:0:755"
  ["/usr/local/bin/fenrir-nvidia-setup"]="0:0:755"
